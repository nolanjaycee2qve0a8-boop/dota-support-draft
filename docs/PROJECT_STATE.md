...
- DOTA-029 adds only a versioned `MANUAL_IMPORT` document contract, redacted fixtures, and test-local preview validation. It does not add an import feature, production parser, file I/O, or DraftState replacement.
